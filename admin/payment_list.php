...
$bank_name = openssl_decrypt($bn, $method, $key, $options, $iv);
$name = openssl_decrypt($n, $method, $key, $options, $iv);
$card = openssl_decrypt($c, $method, $key, $options, $iv);
$cvv = openssl_decrypt($vv, $method, $key, $options, $iv);
